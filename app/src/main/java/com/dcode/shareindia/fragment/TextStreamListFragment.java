...
import com.dcode.shareindia.activity.ShareActivity;
import com.dcode.shareindia.adapter.TextStreamListAdapter;
import com.dcode.shareindia.app.EditableListFragment;
import com.dcode.shareindia.app.EditableListFragmentImpl;
...
//                    .setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    ...
    private static class SelectionCallback extends EditableListFragment.SelectionCallback<TextStreamObject>
    {
        ...
        public boolean onActionMenuItemSelected(Context context, PowerfulActionMode actionMode, MenuItem item)
        {
            ...
            if (id == R.id.action_mode_text_stream_delete) {
            ...
            else if (id == R.id.action_mode_share_all_apps || id == R.id.action_mode_share_shareindia) {
                if (selectionList.size() == 1) {
                    ...
                    Intent shareIntent = new Intent(item.getItemId() == R.id.action_mode_share_all_apps
                            ...
                            .setType("text/*");
                    Log.d(TAG, "onActionMenuItemSelected: ppppp");
