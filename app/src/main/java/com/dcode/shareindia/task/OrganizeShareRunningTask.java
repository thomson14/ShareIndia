package com.dcode.shareindia.task;

import android.net.Uri;
import android.util.Log;

import com.dcode.shareindia.R;
import com.dcode.shareindia.activity.AddDevicesToTransferActivity;
...
public class OrganizeShareRunningTask extends WorkerService.RunningTask<ShareActivity>
{
    ...
    public void onRun()
    {
        ...
        if (getInterrupter().interrupted()) {
           ...
           // ConnectionManagerActivity.startInstance(getService());
        }
